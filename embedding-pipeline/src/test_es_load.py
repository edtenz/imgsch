...
from es_load import embedding_pipeline, do_embedding
...
def test_embedding_pipeline():
    ...
    model = VitBase224()
    res = embedding_pipeline(img_url, model, es_cli, index_name)
    print("res: ", res)
...
def test_do_embedding():
    ...
    model = VitBase224()
    test_count = 10
    suc = do_embedding(MINIO_BUCKET_NAME, model, es_cli, index_name, test_count)
    print("suc: ", suc)
